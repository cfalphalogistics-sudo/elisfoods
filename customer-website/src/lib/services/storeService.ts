...
function normalizeStoreSettings(s: ApiStoreSettings) {
  ...
  return {
    ...
    email: s.email,
    social: {
      facebook: s.social?.facebook || staticSettings.social.facebook,
      instagram: s.social?.instagram || staticSettings.social.instagram,
      tiktok: s.social?.tiktok || staticSettings.social.tiktok,
    },
